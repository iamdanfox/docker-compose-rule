...
public class MessageReportingClusterWait implements ClusterWait {
    private static final Logger log = LoggerFactory.getLogger(MessageReportingClusterWait.class);
    private final ClusterHealthCheck clusterHealthCheck;
    private final Duration timeout;

    public MessageReportingClusterWait(ClusterHealthCheck clusterHealthCheck, Duration timeout) {
